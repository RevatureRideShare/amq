 ...
 * import org.mockito.Mockito; import org.springframework.amqp.rabbit.core.RabbitTemplate; import
 * org.springframework.beans.factory.annotation.Autowired; import
 * org.springframework.boot.test.context.SpringBootTest; import org.junit.Before;
 * 
 * import com.revature.services.RabbitMqServiceImpl;
 * 
 * //! Class to run JUnit tests
 * 
 * @SpringBootTest class RabbitMQServiceImplTests {
 * 
 ...
 * 
 * //! A static instance of the RabbitMQServiceImpl.java class to interact with for tests. private
 * static RabbitMqServiceImpl mqServiceImpl = new RabbitMqServiceImpl();
 * 
 * 
 ...
 * 
 * @Test void sendMessage() { assertTrue(mqServiceImpl.sendMessage(messageToSend, queueName));
 * Mockito.verify(template).convertAndSend(messageToSend, queueName); }
 * 
 * //! Tests if a message can be received by the AMQ.
 * 
 * @Test void receiveMessage() { assertEquals(true,
 * mqServiceImpl.getMessages("UserService!message")); } }
 */
